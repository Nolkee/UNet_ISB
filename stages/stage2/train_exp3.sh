#!/bin/bash
set -euo pipefail
# Stage-2: PatchGAN 调参 Exp-3
# 在 Exp-1 基础上增强 high-frequency loss
...
SAVE_DIR="${SAVE_DIR:-$REPO_ROOT/checkpoints_stage2_exp3_20260411}"
...
CMD=(
  ...
  # Adversarial (Exp-3 = Exp-1 + stronger HF)
  --adv-weight 0.8
  --warmup-epochs 8
...
echo "=========================================="
echo " Stage-2: PatchGAN Tuning (Exp-3)"
